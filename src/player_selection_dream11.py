...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--player_data_filepath",
        required=False,
        help="optional argument indicating the location of data file for "
        "dream11 selection. Default filepath is './data/dream11_performance_data.csv'",
    )

    args = parser.parse_args()
    caller(args.player_data_filepath)
